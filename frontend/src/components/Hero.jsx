...
const Hero = () => {
  ...
  return (
    // MAIN CONTAINER: Flex Column ensures elements stack and don't overlap
    <section className="relative w-full h-[100dvh] flex flex-col text-white overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-between">
        ...
        {/* Using standard flow (no absolute positioning) ensures it sits BELOW the search box on mobile */}
        <div className="w-full bg-gradient-to-t from-[#0f172a] via-[#0f172a]/80 to-transparent pt-12 pb-8 shrink-0">
